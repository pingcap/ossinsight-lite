import { VisualizeConfigProps, VisualizeValue } from './common';
import * as Select from '@radix-ui/react-select';
import { ChangeEvent, useCallback } from 'react';
import { CheckIcon, ChevronDownIcon, ChevronUpIcon } from '@radix-ui/react-icons';
import RoughSvg from '@oss-widgets/roughness/components/RoughSvg';

export default function ValueVisualizeConfig ({ portal, type, title, path, columns, running, onTypeChange, onPropChange }: VisualizeValue & VisualizeConfigProps) {
