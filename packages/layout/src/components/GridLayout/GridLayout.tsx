...
const GridLayout = forwardRef<HTMLDivElement, GridLayoutProps>(function GridLayout ({ guideUi = false, gridSize, gap = 8, children, ...props }, ref) {
  ...
  return (
    <Viewport layout={layout} onResize={setViewportSize} ref={ref} {...props}>
